...
- **Book** (bookID, title, author, ISBN, category)
    
- **Member** (memberID, name, contact)
    
- **Librarian** (staffID, name)
    
- **Loan** (issueDate, dueDate, returnDate)
    
- **Catalog** (searchBook(), listBooks())
    

**Relationships:**

- Member **borrows** Book → _Association_
    
- Librarian **manages** Loan → _Association_
    
- Catalog **contains** Books → _Aggregation_
    
- Loan **depends** on Book & Member → _Dependency_
